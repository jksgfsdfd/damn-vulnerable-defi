...
describe("[Challenge] Free Rider", function () {
  ...
  it("Execution", async function () {
    ...
    // flash swap get eth , buy all the tokens. this would leave 15eth remaining in the marketplace. we can take  this also buy again redepositing 2  nfts to the marketplace and then rebuying. finally transfer all the tokens to the recovery contract.
    ...
    const tokenPriceAndIdData = ethers.utils.defaultAbiCoder.encode(
      ["uint256", "uint256[]"],
      [NFT_PRICE, [0, 1, 2, 3, 4, 5]]
    );
